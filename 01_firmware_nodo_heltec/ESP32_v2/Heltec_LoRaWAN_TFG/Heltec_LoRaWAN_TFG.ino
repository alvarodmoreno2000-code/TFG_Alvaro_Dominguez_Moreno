...
// Identificador incluido en el payload para distinguir el nodo
...
// Intervalo entre transmisiones: 60 segundos.
// Sustituye al periodo anterior de dos segundos.
const uint32_t UPLINK_INTERVAL_MS = 60000UL;
...
void loop() {
  ...
  //
  // node_id, número de secuencia y tiempo desde el arranque.
  //
  // Los parámetros físicos como frecuencia, SF y ancho de
  // banda ya no se incluyen como valores fijos, puesto que
  // pueden ser modificados por LoRaWAN y por ADR.
  ...
  Serial.println("[WAIT] Próximo uplink en 60 segundos");
  Serial.println();
